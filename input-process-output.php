    ...
    <form action="#" method="post" autocomplete="off" class="w-25 mx-auto mt-5">
        ...
        <?php
            ...
            if (isset($_POST['btn_calculate'])) {
                ...
                $result_of_addtion = addTwoNumber($first_num, $second_num);
                echo displayResult($result_of_addtion);
            }

            // process
            function addTwoNumber($first_num, $second_num) {
            ...
            // display output
            function displayResult($result_of_addtion){
                return "The sum of the number is " .  $result_of_addtion;
            }
